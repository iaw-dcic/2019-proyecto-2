      ...
      <tr>
        ...
        <td>
          <div className="hidden-sm hidden-md hidden-lg">
            <input onKeyPress={this.allowNumbersOnly} value={this.props.resultadoEquipo1} id={'resultado_equipo1_partido' + this.props.clave} type="text" className="form-control input-sm" onChange={this.handleChanges}></input>
          </div>
        </td>
        <td> - </td>
        <td>{this.props.nombre_equipo2}</td>
        <td>
          <input onKeyPress={this.allowNumbersOnly} value={this.props.resultadoEquipo2} id={'resultado_equipo2_partido' + this.props.clave} type="text" className="form-control input-sm" onChange={this.handleChanges}></input>
        </td>
        <td>
          <div className="custom-control custom-radio custom-control-inline">
