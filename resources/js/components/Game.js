...
export default class Game extends Component {
    render() {
        var child1 = <button className="list-group-item list-group-item-action myButton" id = {this.props.id1}
                    onClick={this.props.onClick} disabled = {this.props.disable}>{this.props.teamA}</button>
        var child2 =  <button className="list-group-item list-group-item-action myButton" id = {this.props.id2}
