            ...
            response2.data[0].forEach(match => {
                switch(match.phase) {
                    case 'quarter':
                        ...
                        this.setState({cuartos: update(this.state.cuartos,{[match.match_no*2] : {$set: this.state.equipos[Math.floor(match.team1)]}})})
                        this.setState({partidos: update(this.state.partidos,{1: {[match.match_no] : {[1] : {$set: match.team2}}}})})
                        this.setState({cuartos: update(this.state.cuartos,{[match.match_no*2+1] : {$set: this.state.equipos[Math.floor(match.team2)]}})})
                    ...
                    case 'semis':
                        ...
                        this.setState({semis: update(this.state.semis,{[match.match_no*2] : {$set: this.state.equipos[Math.floor(match.team1)]}})})
                        this.setState({partidos: update(this.state.partidos,{2: {[match.match_no] : {[1] : {$set: match.team2}}}})})
                        this.setState({semis: update(this.state.semis,{[match.match_no*2+1] : {$set: this.state.equipos[Math.floor(match.team2)]}})})
                    ...
                    case 'final':
                        ...
                        this.setState({final: update(this.state.final,{0 : {$set: this.state.equipos[Math.floor(match.team1)]}})})
                        this.setState({partidos: update(this.state.partidos,{3: {0 : {[1] : {$set: match.team2}}}})})
                        this.setState({final: update(this.state.final,{1 : {$set: this.state.equipos[Math.floor(match.team2)]}})})
