...
Route::get('/index','TeamController@index')->name('indexTeam')->middleware('auth:api');
Route::get('/user','TeamController@user')->middleware('auth:api');
...
Route::get('/prode/usuario/{user_id}', 'ProdeController@indexUsuario')->middleware('auth:api');
