...
Route::get('static/images/decorations/{id}', 'StaticImageController@getDecorationImage');
Route::get('static/images/decorations', 'StaticImageController@getAllDecorations');
Route::get('static/images/shirts', 'StaticImageController@getAllShirts');
